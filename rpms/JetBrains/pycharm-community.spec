...
%global srcdir   %{name}-community-%{pkgver}
%global appfile  %{name}-community-%{buildid}.tar.gz
...
%global sha256   316637cfeefcf239046e301ac9668a09e32c7badd3bb78bd5d971ad81f4e7613
...
Provides: pycharm-community = %{version}-%{release}
...
# exec
cat > %{buildroot}%{_bindir}/%{name}-eap <<EOF
#!/bin/sh -l
...
%files
%license license/*
%attr(755,root,root) %{_bindir}/%{name}-eap

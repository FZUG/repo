...
%global srcdir   GoLand-%{pkgver}
%global appfile  %{name}-%{pkgver}.tar.gz
%global appurl   https://download.jetbrains.com/go/%{appfile}
%global tranfile resources_zh_CN_GoLand_2018.3_r1.jar
%global tranurl  https://github.com/pingfangx/jetbrains-in-chinese/raw/master/GoLand/%{tranfile}
# curl %%appurl.sha256 | awk '{print$1}'
%global sha256   44953abd37101d44ebf25f858740390cdb2f5fa6e1f9f3c3bc2bb621d837dc6e
%global buildid  183.4886.44
%global pkgver   2018.3.2

Name:     goland
Version:  %{pkgver}.%{buildid}
Release:  1.net%{?dist}
Summary:  A Clever IDE to Go
License:  Apache
URL:      https://www.jetbrains.com/goland
...
%changelog
* Tue Jan  8 2019 mosquito <sensor.wen@gmail.com> - 2018.3.2.183.4886.44-1.net
- Initial build
